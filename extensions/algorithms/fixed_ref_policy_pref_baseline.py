...
from extensions.algorithms.fixed_ref_pref_train_policy import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.fixed_ref_pref_train_policy
import extensions.algorithms.fixed_ref_pref_unique_id_state as unique_id_state
import time
...
def main(
    ...
    for i in range(10):
        ...
        reward_model.update_params(eval_batch_reference_only["current"][:len(eval_batch_reference["current"])],eval_batch_reference["current"], iteration=i)
