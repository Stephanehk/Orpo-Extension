...
from extensions.algorithms.fixed_ref_pref_pandemic_train_policy import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.fixed_ref_pref_pandemic_train_policy
import extensions.algorithms.fixed_ref_pref_pandemic_unique_id_state as unique_id_state
import time
...
def main(
    ...
    original_checkpoint_to_load_policies = copy.deepcopy(checkpoint_to_load_policies)
    for i in range(10):
        ...
        reference_only_result = ex.run(
            config_updates={
                ...
                "checkpoint_to_load_policies": original_checkpoint_to_load_policies,
                "checkpoint_to_load_current_policy": checkpoint_to_load_current_policy,
                "seed": seed,
                "experiment_tag": experiment_tag,
                "om_divergence_type": om_divergence_type,
