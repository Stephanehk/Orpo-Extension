...
from extensions.algorithms.train_policy_3 import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.train_policy_3
import extensions.algorithms.unique_id_state_3 as unique_id_state
import time
...
iterative_ex = Experiment("iterative_reward_design_3", save_git_info=False)
...
def main(
    ...
    for i in range(10):
        ...
        print ("WARNING: not updating reference policy")
