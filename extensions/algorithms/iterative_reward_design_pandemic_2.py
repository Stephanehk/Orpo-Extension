...
from extensions.algorithms.train_policy_pandemic_2 import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.train_policy_pandemic_2
import extensions.algorithms.unique_id_state_pandemic_2 as unique_id_state
import time
...
def main(
    ...
    id_=unique_id_state.state["unique_id"]
    with open(f"active_models/replay_buffer_{id_}.pkl", "rb") as f:
        reward_model.replay_buffer = torch.load(f)
    reward_model.replay_buffer.buffer = reward_model.replay_buffer.buffer
    ...
    for i in range(10):
        ...
        #data/logs/pandemic/2025-05-12_13-57-44/checkpoint_000025
