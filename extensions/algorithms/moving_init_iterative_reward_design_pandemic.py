...
from extensions.algorithms.moving_init_train_policy_pandemic import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.moving_init_train_policy_pandemic
import extensions.algorithms.moving_init_unique_id_state_pandemic as unique_id_state
import time
...
def main(
    ...
    checkpoint_to_load_current_policy = "/next/u/stephhk/orpo/data/logs/pandemic/2025-05-13_10-27-22/checkpoint_000025"
    checkpoint_to_load_policies = ['/next/u/stephhk/orpo/data/logs/pandemic/2025-05-13_10-27-22/checkpoint_000025'] #from run 10344158 
    reward_model.update_params(None, None, iteration=0,debug_mode=True,use_minibatch=True)
