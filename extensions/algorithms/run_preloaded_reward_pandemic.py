...
from extensions.algorithms.preloaded_reward_train_policy_pandemic import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.preloaded_reward_train_policy_pandemic
import extensions.algorithms.preloaded_reward_unique_id_state_pandemic as unique_id_state
import time
...
def main(
    ...
    reward_model.load_state_dict(torch.load(f"active_models/reward_model_{500}.pth"))
    reward_model.save_params()
