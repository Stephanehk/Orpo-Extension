...
ex = Experiment("orpo_experiments_preloaded", save_git_info=False)
...
def main(
    ...
    eval_batch = synchronous_parallel_sample(
            worker_set=algorithm.workers, max_env_steps=193*2*70 #worker_set=algorithm.workers, max_env_steps=algorithm.config.train_batch_size
        )
