...
from extensions.reward_modeling.reward_wrapper_tri_pol import RewardWrapper,RewardModel
from pandemic_simulator.environment.pandemic_env import PandemicPolicyGymEnv

from extensions.algorithms.tri_pol_train_policy import ex
from extensions.environments.pandemic_configs import get_pandemic_env_gt_rew
import extensions.algorithms.tri_pol_train_policy
import extensions.algorithms.tri_pol_unique_id_state as unique_id_state
import time
...
def main(
    ...
    for i in range(10):
        ...
        constrained_rollouts = eval_batch_reference["current"]
        unconstrained_rollouts = eval_batch_over_opt["current"][:len(constrained_rollouts)]
        reference_rollouts = eval_batch_reference_only["current"][:len(constrained_rollouts)]
        reward_model.update_params(unconstrained_rollouts,constrained_rollouts,reference_rollouts, iteration=i)
