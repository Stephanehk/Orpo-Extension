...
from extensions.algorithms_pandemic_pref_against_moving_ref.train_policy import ex
import extensions.algorithms_pandemic_pref_against_moving_ref.train_policy
import extensions.algorithms_pandemic_pref_against_moving_ref.unique_id_state as unique_id_state
import time

import warnings
warnings.filterwarnings("ignore")

iterative_ex = Experiment("iterative_reward_design_pandemic_pref_against_moving_ref", save_git_info=False)
...
def main(
    ...
    ref_checkpoint_to_load_current_policy= checkpoint_to_load_current_policy
    for i in range(10):
        ...
        over_opt_result = ex.run(
            config_updates={
                ...
                "checkpoint_to_load_policies": None,
                "checkpoint_to_load_current_policy": ref_checkpoint_to_load_current_policy,
                "seed": seed,
        ...
        ref_checkpoint_to_load_current_policy = "/next/u/stephhk/orpo/"+reference_result.result[1]
