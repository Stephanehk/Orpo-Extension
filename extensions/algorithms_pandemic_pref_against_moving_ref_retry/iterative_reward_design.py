...
from extensions.algorithms_pandemic_pref_against_moving_ref_retry.train_policy import ex
import extensions.algorithms_pandemic_pref_against_moving_ref_retry.train_policy
...
iterative_ex = Experiment("iterative_reward_design_pandemic_pref_against_ref_retry", save_git_info=False)
