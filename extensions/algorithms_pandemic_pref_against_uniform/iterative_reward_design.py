...
from extensions.algorithms_pandemic_pref_against_uniform.train_policy import ex
import extensions.algorithms_pandemic_pref_against_uniform.train_policy
import extensions.algorithms_pandemic_pref_against_uniform.unique_id_state as unique_id_state
import time

import warnings
warnings.filterwarnings("ignore")

iterative_ex = Experiment("iterative_reward_design_pandemic_pref_against_unif", save_git_info=False)
...
def main(
    ...
    for i in range(10):
        ...
        reward_model.update_params(unif_policy_rollouts,reference_rollouts, iteration=i,use_minibatch=True)
