...
from extensions.algorithms_pandemic_r_sas_short.train_policy import ex
import extensions.algorithms_pandemic_r_sas_short.train_policy
...
iterative_ex = Experiment("iterative_reward_design_pandemic_sas_short", save_git_info=False)
