...
import extensions.algorithms_traffic_constrained_test_1.unique_id_state as unique_id_state
...
def create_env_traffic(config,flow_params, reward_specification, reward_fun, reward_scale):
    ...
    # assert False
    #custom_traffic_sas
    return RewardWrapper(base_env, reward_model=config.get("reward_model", "default"), unique_id=unique_id_state.state["unique_id"])

ex = Experiment("algorithms_traffic_constrained_test_1_", save_git_info=False)
