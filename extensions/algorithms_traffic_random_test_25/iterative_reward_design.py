...
from extensions.algorithms_traffic_random_test_25.dup_configs import dup_configs

from extensions.algorithms_traffic_random_test_25.train_policy import ex,create_env_traffic
import extensions.algorithms_traffic_random_test_25.train_policy
import extensions.algorithms_traffic_random_test_25.unique_id_state as unique_id_state
import time
...
def main(
    ...
    reference_result = ex.run(
        config_updates={
            ...
            "checkpoint_to_load_policies": [random_checkpoint_path],
